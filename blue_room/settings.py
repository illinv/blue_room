"""
Django settings for blue_room project.
...
SECRET_KEY = '1ls61&^xj@v%lg2rmnh%zdl0liibu4gcxenncxlzyms+1nmj#='
...
WSGI_APPLICATION = 'blue_room.wsgi.application'
